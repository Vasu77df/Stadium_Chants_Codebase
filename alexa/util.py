...
def shuffle_order():
    # type: () -> List
    chant_indices = [l for l in range(0, len(data.AUDIO_DATA))]
    random.shuffle(chant_indices)
    return chant_indices
...
class Controller:
    ...
    def play(handler_input, is_playback=False):
        ...
        chant = data.AUDIO_DATA[play_order[index]]
        ...
        if not is_playback:
            ...
            handler_input.response_builder.speak(
                data.PLAYBACK_PLAY.format(chant.get("title")))
